#!/usr/bin/env python3
"""
Script to get detailed information about any project by key
"""
...
async def analyze_any_project(project_key, project_name):
    """Get detailed information about any project by key"""
    try:
...
if __name__ == "__main__":
    if len(sys.argv) != 3:
        print("Usage: python analyze_project.py <project_key> <project_name>")
        print("Example: python analyze_project.py jatis_coster_contact_export \"Jatis Coster Contact Export\"")
        sys.exit(1)
    
    project_key = sys.argv[1]
    project_name = sys.argv[2]
    asyncio.run(analyze_any_project(project_key, project_name))